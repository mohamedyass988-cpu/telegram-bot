...
Token = "8526935801:AAGqEAor9n91knVeDoTXF5mQdgqS_udPEY8"  # توكنك
admin = 8590809949 # ايديك
API_KEY = Token
...
def process_update(update):
    ...
    RBEROO = {
        'inline_keyboard': [
            ...
            [{"text": "📨┇الدعم الفني .", "url": "https://t.me/elasfeh"}]
        ]
    }
    ...
    if message and text == "/start" and hHbero == "I":
        ...
        if e1_hack and str(e1_hack) != str(from_id):
            if str(from_id) not in rshq.get("3thu", []):
                ...
                bot('sendMessage', {
                    'chat_id': chat_id,
                    'text': f"*✅┇مرحبا بك في بوت رشق[السفاح المصري اليوتيوبر]*\n\n⚙┇رصيدك : *{coin}*\n📺┇ايديك : `{from_id}`\n🕹┇العملة : *نقاط*\n\n*⬇️┇تحكم بالازرار عبر الاسفل* \n",
                    'parse_mode': "markdown",
